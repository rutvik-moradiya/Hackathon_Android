...
public class Agriculture extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] macroeconomics = new String[]{Constants.CONTRIBUTION_TO_GDP, Constants.FERTILIZER_PRODUCTION, Constants.FERTILIZER_USE, Constants.CREDIT};
...
//        usaCheckBox.setOnCheckedChangeListener(this);
        ...
        if (dbHelper.isDatabaseEmpty(Constants.CONTRIBUTION_TO_GDP)) {
            try {
                ...
                while ((line = reader.readLine()) != null) {
                    try {
                        ...
                        String china = row[2];
                        String usa = row[3];
                        String macroeconomics = Constants.CONTRIBUTION_TO_GDP;
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    String china = row[2];
                    String usa = row[3];
                    String macroeconomics = Constants.FERTILIZER_PRODUCTION;
                    dbHelper.insertData(Integer.parseInt(year), Double.parseDouble(india), Double.parseDouble(china), Double.parseDouble(usa), macroeconomics);
                }
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    String china = row[1];
                    String usa = row[3];
                    String macroeconomics = Constants.FERTILIZER_USE;
                    dbHelper.insertData(Integer.parseInt(year), Double.parseDouble(india), Double.parseDouble(china), Double.parseDouble(usa), macroeconomics);
                }
