...
public class MacroEconomy extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] macroeconomics = new String[]{Constants.GDP_GROWTH, Constants.GDP_USD, Constants.FDI_INWARD, Constants.FDI_OUTWARD};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_macro_economy);
        ...
        try {
            ...
            if (dbHelper.isDatabaseEmpty(Constants.GDP_GROWTH)) {
                reader.readLine();
                while ((line = reader.readLine()) != null) {
                    ...
                    String china = row[2];
                    String usa = row[3];
                    String macroeconomics = Constants.GDP_GROWTH;
            ...
            if (dbHelper.isDatabaseEmpty(Constants.GDP_USD)) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    String china = row[2];
                    String usa = row[3];
                    String macroeconomics = Constants.GDP_USD;
                    dbHelper.insertData(Integer.parseInt(year), Double.parseDouble(india), Double.parseDouble(china), Double.parseDouble(usa), macroeconomics);
                }
            }

            if (dbHelper.isDatabaseEmpty(Constants.FDI_INWARD)) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    String china = row[1];
                    String usa = row[3];
                    String macroeconomics = Constants.FDI_INWARD;
                    dbHelper.insertData(Integer.parseInt(year), Double.parseDouble(india), Double.parseDouble(china), Double.parseDouble(usa), macroeconomics);
                }
            }

            if (dbHelper.isDatabaseEmpty(Constants.FDI_OUTWARD)) {
                ...
                while ((line = reader.readLine()) != null) {
                    ...
                    String china = row[1];
                    String usa = row[3];
                    String macroeconomics = Constants.FDI_OUTWARD;
                    dbHelper.insertData(Integer.parseInt(year), Double.parseDouble(india), Double.parseDouble(china), Double.parseDouble(usa), macroeconomics);
                }
            }
        } catch (IOException e) {
